export function TextInput({ type = 'text', value, onChange, placeholder, min, max, step, disabled = false }) {
  const style = {
  ...
  return (
    <input
      type={type} value={value} placeholder={placeholder} min={min} max={max} step={step} disabled={disabled}
      style={style}
