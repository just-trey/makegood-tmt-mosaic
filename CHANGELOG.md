...
- **The Back design sheet no longer draws four no-print slots that aren't
  ...
  themselves, enclosing 42-45mm² of area against a perimeter twice their length,
  so they passed the bake's area-only test for a real hole. The Back sheet drew
  them as gaps to keep artwork clear of, and the app excluded that surface from
