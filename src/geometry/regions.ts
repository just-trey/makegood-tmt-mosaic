 ...
 * "A cut region claims surface the part does not have, and it prints" — those pieces turned out
 * not to be thin surface but surface-less, off the chart's triangles, where no floor reaches them.
 *
